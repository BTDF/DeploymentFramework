...
DeployTools\NAntSubset\nant.exe -D:skipUndeploy=true -D:deployBizTalkMgmtDB=%BT_DEPLOY_MGMT_DB% -l:DeployResults\DeployResults.txt -logger:"NAnt.ColorConsoleLogger.ColorConsoleLogger,NAnt.ColorConsoleLogger" serverDeploy
