...
namespace SSOSettingsFileManager
{
	...
	[clp.ParserUsage("Import a settings file (as generated by SettingsFileGenerator.xls) into the SSO.")]
	class SSOSettingsFileImportCommandLine : CommandLineParser
	{
		...
		public string affiliateAppName;
	...
	class SettingsFileImport
	{
			...
			string adminGroupName)
		{
			...
			Console.WriteLine("Settings file was associated with application in SSO.");
