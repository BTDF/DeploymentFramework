...
%BTDFMSBuildPath% /p:DeployBizTalkMgmtDB=%BT_DEPLOY_MGMT_DB%;Configuration=Server;SkipUndeploy=true /target:Deploy /l:FileLogger,Microsoft.Build.Engine;logfile=..\DeployResults\DeployResults.txt %1
@echo on
@echo -----
@echo off
