...
namespace DeploymentFramework.VisualStudioAddIn
{
    internal class CommandManager
    {
        ...
        internal const string DecodeBindingsCommandName = "DecodeBindings";
        ...
        internal void CreateCommands()
        {
            ...
            CreateCommand(
                DecodeBindingsCommandName,
                "Decode BizTalk Bindings",
                "Decodes embedded XML fragments inside the bindings XML file",
                1,
                DefaultCommandStatus,
                (int)vsCommandStyle.vsCommandStyleText,
                vsCommandControlType.vsCommandControlTypeButton,
            ...
            CreateCommand(
                ...
                "Pre-processes bindings to create PortBindings.xml from PortBindingsMaster.xml",
                1,
                DefaultCommandStatus,
                (int)vsCommandStyle.vsCommandStyleText,
                vsCommandControlType.vsCommandControlTypeButton,
